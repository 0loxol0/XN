...
def pengikut(token, user):
	...
	try:
		...
		url = "https://graph.facebook.com/{}/subscribers?fields=name,id&limit=90000&access_token={}".format(user, token)
		url_ = "https://graph.facebook.com/{}/subscribers?limit=90000&access_token={}".format(user, token)
		t = te.replace(te, "")
		with requests.Session() as ses_:
			try:
